...
function applyTimelineVisuals(
  ...
  fg.nodeThreeObject((node: any) => {
    ...
    return buildTimelineNodeObject(data, featuredEventId, masterBrightness, highlightedForkId)
  })
...
export default function ThreeCanvas() {
  ...
  useEffect(() => {
    ...
    applyTimelineVisuals(fg, [], [], null, 1, null)
    ...
    const animate = () => {
      ...
      scene.traverse((obj) => {
        if (obj.name === 'timeline-latest-ring' || obj.name === 'npc-latest-ring' || obj.name === 'npc-fork-anchor-ring' || obj.name === 'fork-highlight-ring') {
  ...
  useEffect(() => {
    ...
    applyTimelineVisuals(fg, nodes, edges, featuredEventId, masterBrightness, highlightedForkId)
    fg.refresh()
  }, [nodes, edges, featuredEventId, masterBrightness, highlightedForkId])
