...
import type { PlayerCareerEvent } from '../types'
...
const EMPTY_CAREER_EVENTS: PlayerCareerEvent[] = []
...
function PlayerFateDetail({
  ...
  const careerEvents = useStore((s) => s.playerCareerEvents[playerId]) ?? EMPTY_CAREER_EVENTS
